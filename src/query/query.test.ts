...
describe.concurrent('query', function () {
  ...
  it('can fetch expired resources while returning stale', async ({ expect }) => {
    function fetcher() {
  ...
  it('can fetch expired resources while not returning stale', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('does respect dedupe interval of resources', async ({ expect }) => {
    let times = 0
    function fetcher() {
      times++
      return Promise.resolve('example')
  ...
  it('does respect dedupe interval of resources 2', async ({ expect }) => {
    let times = 0
    function fetcher() {
      times++
      return Promise.resolve('example')
  ...
  it('can subscribe to refetchings on resources', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can subscribe to refetchings on pending resources', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can subscribe to resolutions on resources', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can subscribe to mutations on resources', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can mutate non-existing cache keys when using a fn', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can subscribe to mutations on resources 2', async ({ expect }) => {
    function fetcher() {
  ...
  it('can subscribe to aborts on resources', async ({ expect }) => {
  ...
  it('can subscribe to aborts on resources with custom reason', async ({ expect }) => {
    const err = new Error('aborted')
  ...
  it('can subscribe to forgets on resources', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can subscribe to hydrates on resources', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can reconfigure query', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can reconfigure query 2', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can abort query', async ({ expect }) => {
    const err = new Error('aborted')
  ...
  it('can get the item keys of a query', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can get the resolvers keys of a query', ({ expect }) => {
    async function fetcher() {
  ...
  it('can forget a query key', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can forget a query key 2', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('can forget a query key 3', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('example')
    }
  ...
  it('removes resolver when query fails', async ({ expect }) => {
  ...
  it('removes items if specified when query fails', async ({ expect }) => {
    function fetcher(): Promise<string> {
      throw new Error('foo')
    }
  ...
  it('can subscribe to errors', async ({ expect }) => {
    function fetcher(): Promise<string> {
      throw new Error('foo')
    }
  ...
  it('can give a fresh instance if needed', async ({ expect }) => {
    let times = 0
    function fetcher() {
      times++
      return Promise.resolve('example')
  ...
  it('uses stale data while resolving', async ({ expect }) => {
  ...
  it('can get expiration date of items', async ({ expect }) => {
    function fetcher() {
  ...
  it('can hydrate keys', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('foo')
    }
  ...
  it('can hydrate keys without expiration', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('foo')
    }
  ...
  it('can hydrate multiple keys', async ({ expect }) => {
    function fetcher() {
      return Promise.resolve('foo')
    }
  ...
  it('can use regex to forget the keys', async ({ expect }) => {
  ...
  it('can listen to once events', async ({ expect }) => {
  ...
  it('can return a data snapshot', async function ({ expect }) {
  ...
  it('can access caches', function ({ expect }) {
